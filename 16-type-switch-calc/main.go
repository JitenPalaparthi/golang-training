...
func main() {
	...
	r, err := calc(true, "hello World")

	fmt.Println(r, err)

	r, err = calc(float64(34.34), float64(67.7))

	fmt.Println(r, err)

	r, err = calc(float32(123), float32(433.4))
	fmt.Println(r, err)

	r, err = calc(int8(123), int8(4))
	fmt.Println(r, err)
...
func calc(a, b any) (float64, error) {
	sum := 0.0
